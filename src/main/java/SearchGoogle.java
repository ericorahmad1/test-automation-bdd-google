...
public class SearchGoogle {
    ...
    public void showingResultRelatedWith(String result) {
        driver.findElement(By.xpath("//a[@href='https://id.linkedin.com/in/erico-rahmad-darmanto-3aab01126']")).isDisplayed();
        String urlLinkedinEric = driver.findElement(By.xpath("//a[@href='https://id.linkedin.com/in/erico-rahmad-darmanto-3aab01126']")).getText();
        System.out.println(urlLinkedinEric);
        driver.close();
        driver.quit();
